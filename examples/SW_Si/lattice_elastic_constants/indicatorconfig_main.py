...
* Candidate configurations: The example dataset in KLIFF for Si with varying lattice
  constants.
* Target QoI: equilibrium lattice constant, cohesive energy, and elastic constants of
...
model_target = ModelLatticeElastics(
    data=elasticconstants_data["data"], error=target_error
)
...
while step < maxsteps:
    ...
    fim_target_file = FIM_DIR / "elasticconstants.npy"
    ...
    nprocs = 20  # Number of parallel processes
    # Energy
